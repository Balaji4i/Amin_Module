...
import fusion.um.model.POJO.pojo_seg2;
...
// ---------------------------------------------------------------------
public class Segment2_PROGVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public Segment2_PROGVOImpl() {
    }
    ...
    public void populateData() throws SQLException {
        ...
        try {
            ...
            //step4 execute query
            rs =
 stmt.executeQuery("select * from xxfnd_data_security where SEGMENT_COLUMN='SEGMENT2'");
...
"select " + b + "," + c + " from xxfnd_lookup_types t, " + a +
  ...
  d + "'";
            ...
            while (rs1.next()) {
                ...
                characterList.add(new pojo_seg2(rs1.getString(1),
                                                rs1.getString(2)));
    ...
    private ArrayList<pojo_seg2> characterList = new ArrayList<pojo_seg2>();
    ...
    protected ViewRowImpl createRowFromResultSet(Object qc,
        ...
        // Create a new row
        Segment2_PROGVORowImpl characterRow =
            (Segment2_PROGVORowImpl)createNewRowForCollection(qc);
        //Here set attribute values in new row using RowImpl class
        characterRow.setSeg2Key(characterList.get(curIndex).getId());
        characterRow.setSeg2Value(characterList.get(curIndex).getName());
